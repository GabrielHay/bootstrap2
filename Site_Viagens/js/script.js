...
$(document).ready(function(){
    ...
    $("#telefone_cel").blur(function(){
        ...
        if(!cel.test($("#telefone_cel").val())){
            if($("#telefone_cel").val() == ''){
                alert("O campo Telefone Celular é obrigatorio, informe um numero válido para proceder");
            }else{
                alert("O numero de telefone celular informado é inválido, insira no campo um numero válido");
            }
        }else{
    ...
    $("#telefone_res").blur(function(){
        var res = /^\([1-9]{2}\)[0-9]{4}\-[0-9]{4}/;

        if(!res.test($("#telefone_res").val())){
            if($("telefone_res").val() == ''){
                alert("O campo Telefone Residencial é obrigatorio, informe um numero válido para proceder");
            }else{
                alert("O numero de telefone residencial informado é inválido, insira no campo um numero válido")
            }
        }else{
